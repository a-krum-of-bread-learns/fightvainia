...
func _validate_property(property: Dictionary) -> void:
	if property.name in ["hit_stun_duration", "hit_back_distance_vector"] and stun_type in [StunManager.STUN_TYPE.DEFUALT_LAUNCH, StunManager.STUN_TYPE.DEFUALT_AIR,StunManager.STUN_TYPE.DEFUALT_KNOCK_DOWN]:
