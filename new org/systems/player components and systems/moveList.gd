...
# -------------------------
@onready var all_specials: Dictionary = {}
@onready var command_normals: Dictionary = {}
@onready var neutral_normals: Dictionary = {}
@onready var all_attacks: Dictionary = {}

# removes all the nulls and filters attacks into priority categories
func _ready():
	var normals_temp: Dictionary = {}
