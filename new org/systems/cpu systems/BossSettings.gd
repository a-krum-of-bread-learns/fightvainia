...
@export_range(0,1,.01) var attack_chance: float = .02 # at 0.02 its rough;y 1 attack a second
@export_range(0,1,.01) var combo_drop_chance_each_attack: float = 0
...
@export_range(0,1,.01) var anti_air_chance: float = 1
@export_range(0,1,.01) var poke_chance: =.1
